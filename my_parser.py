...
parser.add_argument('--updates', type=int, default=4000, help='Number of updates to train.')
parser.add_argument('--eval-batches', type=int, default=0, help='Number of batches in eval')
parser.add_argument('--log-every', type=int, default=400, help='Display and write logs every such steps.')
...
parser.add_argument('--use-em', action='store_true', help='enable Vose Alias Sampling')