...
parser.add_argument('--use-em', action='store_true', help='use EM to train vGraph')
parser.add_argument('--m-step', type=int, default=20, help='Number of batches for M-step')
