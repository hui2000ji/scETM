...
parser.add_argument('--log-every', type=int, default=1200, help='Display and write logs every such steps (depracated)')
parser.add_argument('--log-interval', type=int, default=50, help='Number of epochs between loggings')
parser.add_argument('--emb-dim', type=int, default=128, help='Embedding dimensions')
...
parser.add_argument('--linear-anneal-eta', type=int, default=2400, help='linear annealing of cell type center distancing term')
...
parser.add_argument('--group-by', type=str, default='condition', help='dataframe (adata.obs) column to group the cells by')
